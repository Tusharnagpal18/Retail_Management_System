...
//            java.sql.Connection con=DriverManager.getConnection("jdbc:sqlserver://localhost:49949;databaseName=Retailmgt","sa","bds123");
              String tushar="select * from m_pay_mod";
           
            PreparedStatement pst=con.prepareStatement(tushar);
            ResultSet rs=pst.executeQuery();
            display_pay.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        display_pay = new javax.swing.JTable();
        ...
        display_pay.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        display_pay.getTableHeader().setReorderingAllowed(false);
        display_pay.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                display_payMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                display_payMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                display_payMouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                display_payMousePressed(evt);
            }
        });
        jScrollPane1.setViewportView(display_pay);
    ...
    private void display_payMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_payMouseClicked

        int row=display_pay.getSelectedRow();
        String id1=display_pay.getValueAt(row, 0).toString();
        String desc1=display_pay.getValueAt(row,1).toString();
        System.out.println("desc is "+desc1);
        m_pay_mode mu=new m_pay_mode();
        mu.pid=id1;
        mu.pdesc=desc1;
        mu.refresh(mu.pid, mu.pdesc);
        mu.k=1;
        this.dispose();
    }//GEN-LAST:event_display_payMouseClicked

    private void display_payMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_payMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_display_payMouseEntered

    private void display_payMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_payMouseExited
        // TODO add your handling code here:
    }//GEN-LAST:event_display_payMouseExited

    private void display_payMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_display_payMousePressed
        // TODO add your handling code here:
    }//GEN-LAST:event_display_payMousePressed
    ...
    public javax.swing.JTable display_pay;
